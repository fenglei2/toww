...
public class Event {
	...
	//current alive, includes current survival time's death, exclude the paitents already counted 
	...
	public Event(double time,double currtotal,double ndeath,double naliveFromGroup2, int group){
		this.time=time;
...
//		System.out.println("dd: "+currTotal+" "+ndeath+" "+proportionSurvival);
	...
	public String toString(){
		return currTotal+" "+risk+" "+ndeath+" "+naliveFromGroup2+" "+group+"\n";
	}
